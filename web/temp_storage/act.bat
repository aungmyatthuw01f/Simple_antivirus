...
echo. & echo 正在检查激活服务器.....
echo.
ping xykz.f3322.org  | find "超时"  > NUL &&  goto fail
ping xykz.f3322.org  | find "目标主机"  > NUL &&  goto fail
::备用服务器，如失效可用备用的替换kms.03k.org、cy2617.jios.org、kms.guowaifuli.com
...
if defined %EditionID% (
        ...
        cscript //Nologo %windir%\system32\slmgr.vbs /skms xykz.f3322.org
...
if DEFINED _Office%1Path (
    cd /d "!_Office%1Path!"
        ...
        echo.&echo  %2 已经激活，自动跳过  & echo.) || (
                ...
                cscript //nologo ospp.vbs /sethst:xykz.f3322.org  >nul
